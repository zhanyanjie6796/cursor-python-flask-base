...
本專案內建訪問者日誌功能，每當有人訪問網站時，會在控制台輸出訪問記錄：

```
[訪問] 2025-12-25 09:45:00 | IP: 203.145.xx.xx | 頁面: / | 裝置: Mozilla/5.0 (Windows NT 10.0)...
```
...
1. 前往 [render.com](https://render.com) 並註冊帳號（可用 GitHub 登入或 gmail：jackXX6）
